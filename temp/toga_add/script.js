...
document.querySelectorAll('[data-action="open-report"]').forEach((card) => {
  card.addEventListener("click", () => {
    ...
    reportModalDate.textContent = date;
    reportModalType.textContent = type;
    reportModalDescription.textContent = description;

    reportModalImage.src = image;
    reportModalImage.alt = title;
